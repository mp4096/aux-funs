/*
 *   sfun_chol_downdate_real.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        int32 y2 = sFunWrapper(double y1[size(u1,1)][size(u1,2)], uint32 p1[1], double u1[][], double u2[])
 *
 *   Simulink version           : 8.6 (R2015b) 13-Aug-2015
 *   C source code generated on : 20-May-2016 19:50:59
 ...
 */
#define S_FUNCTION_NAME                sfun_chol_downdate_real
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "sFunWrapper", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
